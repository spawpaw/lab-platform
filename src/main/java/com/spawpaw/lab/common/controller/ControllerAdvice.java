package com.spawpaw.lab.common.controller;

import com.spawpaw.lab.exception.ExceptionInfoService;
...
@RestControllerAdvice(basePackages = {"com.spawpaw.lab.service"})
@RestController
